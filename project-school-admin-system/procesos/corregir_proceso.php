...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Si hay tarea relacionada, cambiar estado a "en_progreso"
        ...
        $conn->commit();
        header("Location: procesos.php?success=Proceso corregido y enviado para autorización");
        exit();
...
<head>
    ...
    <title>Corregir Proceso</title>
    <link rel="stylesheet" href="editar_proceso1.css">
</head>
<body>
    <div class="container">
        <h1>Corregir Proceso</h1>
        <a href="../tareas/tareas.php" class="back-button">← Volver a Tareas</a>
        ...
        <button type="submit">Guardar y Mandar para Autorizar</button>
    </form>
</body>
</html>
<?php
